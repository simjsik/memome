...
<div>
  주요 기능
  <p>
    $\small{\color{#9097a2}\quad · 포스트\ CRUD}$
    <br/>
    $\small{\color{#9097a2}\quad · 무한\ 스크롤\ 페이지}$
    <br/>
    $\small{\color{#9097a2}\quad · 유저\ 인증\ 관리}$
    <br/>
    $\small{\color{#9097a2}\quad · Cloudinary\ 이미지\ 최적화}$
    <br/>
    $\small{\color{#9097a2}\quad · Algolia\ Search\ 연동\ 및\ 구현}$
    <br/>
    $\small{\color{#9097a2}\quad · 모바일| 태블릿| PC\ 반응형\ UI}$
    <br/>
    $\small{\color{#9097a2}\quad · Github\ 및\ Vercel\ 배포를\ 통해\ CI|CD\ 테스트\ 및\ 빌드\ 자동화\ 배포}$
  </p>
...
<div style="margin: 0 auto; text-align: center;" align= "left">
  ...
  <img src="https://img.shields.io/badge/Illustrator-orange?style=flat">
  <br/>
</div> 
  <br/>
  <p>
 ...
 <img src="https://github.com/user-attachments/assets/79f86a8c-62a1-4634-8070-93f9f469779a">
 <img src="https://github.com/user-attachments/assets/9ed78cf9-98c2-4a60-ae5b-f72e646e5a4d">
 <img src="https://github.com/user-attachments/assets/816b3816-533b-49c3-88c1-54efb34c6f2f">
